...
// const TARGET_DATE = new Date("2027-06-20T23:59:00");
const TARGET_DATE = new Date("2027-06-06T00:00:00");
...
<p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-[#D4D4D8] md:text-lg md:leading-8">
  Thank you to everyone who participated in the YOULIBUS Awards 2026.
  Voting is now officially closed. The countdown below is for the
  next voting season, which begins on
...
<p className="text-sm text-[#A1A1AA]">
  Voting has officially ended. The countdown above shows the time
  remaining until voting opens for the 2027 edition.
</p>
        </div>
      </div>
